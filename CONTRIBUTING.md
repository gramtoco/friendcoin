Contributing to Pejecoin Core
============================

The Pejecoin Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *GUI* for changes to pejecoin-qt
  - *Mining* for changes to the mining code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST/ZMQ* for changes to the RPC, REST or ZMQ APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the pejecoin unit tests or QA tests
...
The following applies to code changes to the Pejecoin project (and related
projects) and is not to be confused with overall Pejecoin
Network Protocol consensus changes.

Whether a pull request is merged into Pejecoin rests with the project merge
...
Patches that change Pejecoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Pejecoin consensus, it must have been
...
The PejecoinQT-SIG selects a release manager for each Pejecoin release.

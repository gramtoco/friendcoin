...
### IPFS Pinner
Loops through blocks and transactions and pins asset issuance meta-data and then monitors frend transactions for new ipfs metadata via zmq.
...
* Run frend or fren-qt with parameter to use zmq: ```-zmqpubrawtx=tcp://127.0.0.1:24206```

...
Below are some notes on how to build Fren Core for Windows.
...
way. This will install to `c:\workspace\fren`, for example:

    make install DESTDIR=/mnt/c/workspace/fren

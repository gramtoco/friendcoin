...
Below are some notes on how to build Pejecoin Core for Windows.
...
way. This will install to `c:\workspace\pejecoin`, for example:

    make install DESTDIR=/mnt/c/workspace/pejecoin

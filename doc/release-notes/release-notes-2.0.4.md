Fren Core version *2.0.4.0* is now available!!
==============

  <https://github.com/Apushii/Frencoin/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/Apushii/Frencoin/commits/release_2.0.4>

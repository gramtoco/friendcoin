...
import os
import struct
from test_framework.test_framework import FrenTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(FrenTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that fren has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("frend has not been built with zmq enabled.")

...
import os
import struct
from test_framework.test_framework import PejecoinTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(PejecoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that pejecoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("pejecoind has not been built with zmq enabled.")

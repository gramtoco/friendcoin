...
# TestNode: A peer we use to send messages to pejecoind, and store responses.
...
class CompactBlocksTest(PejecoinTestFramework):
    ...
    # This test actually causes pejecoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that pejecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for pejecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # pejecoind will not send blocktxn responses for blocks whose height is

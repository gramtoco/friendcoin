...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the FrenTestFramework
    pass

class ExampleTest(FrenTestFramework):
    # Each functional test is a subclass of the FrenTestFramework class.
    ...
    def custom_method(self):
        ...
        FrenTestFramework class so other tests can use it."""

...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the PejecoinTestFramework
    pass

class ExampleTest(PejecoinTestFramework):
    # Each functional test is a subclass of the PejecoinTestFramework class.
    ...
    def custom_method(self):
        ...
        PejecoinTestFramework class so other tests can use it."""

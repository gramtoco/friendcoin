...
By default, frend will dump mempool on shutdown and
...
class MempoolPersistTest(FrenTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give frend a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent frend from writing mempool.dat to disk. Verify that `savemempool` fails")

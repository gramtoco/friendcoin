...
By default, pejecoind will dump mempool on shutdown and
...
class MempoolPersistTest(PejecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give pejecoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent pejecoind from writing mempool.dat to disk. Verify that `savemempool` fails")

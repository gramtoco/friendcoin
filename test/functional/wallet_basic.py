...
class WalletTest(FrenTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 FRENS from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 FRENS with subtract fee from amount
        ...
        # Sendmany 10 FRENS with subtract fee from amount

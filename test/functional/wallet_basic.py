...
class WalletTest(PejecoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 PEJE from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 PEJE with subtract fee from amount
        ...
        # Sendmany 10 PEJE with subtract fee from amount

...
class TestFrenCli(FrenTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `fren-cli getinfo`")
        ...
        self.log.info("Compare responses from `fren-cli -getinfo` and the RPCs data is retrieved from.")

...
class BIP66Test(PejecoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # pejecoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and pejecoind produces more specific reject
            # reasons.

...
class BIP66Test(FrenTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # frend is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and frend produces more specific reject
            # reasons.

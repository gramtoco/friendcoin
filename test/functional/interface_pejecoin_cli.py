...
class TestPejecoinCli(PejecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `pejecoin-cli getinfo`")
        ...
        self.log.info("Compare responses from `pejecoin-cli -getinfo` and the RPCs data is retrieved from.")

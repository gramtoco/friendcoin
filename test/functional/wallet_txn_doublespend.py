...
class TxnMallTest(FrenTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 FRENS:
        ...
        # First: use raw transaction API to send 1240 FRENS to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 FRENS coin each
        ...
        # Node0's balance should be starting balance, plus 50FRENS for another
        ...
        # Node0's total balance should be starting balance, plus 100FRENS for 

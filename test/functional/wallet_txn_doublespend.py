...
class TxnMallTest(PejecoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 PEJE:
        ...
        # First: use raw transaction API to send 1240 PEJE to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 PEJE coin each
        ...
        # Node0's balance should be starting balance, plus 50PEJE for another
        ...
        # Node0's total balance should be starting balance, plus 100PEJE for 

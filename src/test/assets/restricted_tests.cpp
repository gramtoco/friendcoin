...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler peje tx
        CScript pejeTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut pejeOut(1*COIN, pejeTransfer);
        ...
        mutTxTest1.vout.emplace_back(pejeOut);
        ...
        mutTxTest2.vout.emplace_back(pejeOut);
        ...
        mutTxTest3.vout.emplace_back(pejeOut);
        ...
        mutTxTest4.vout.emplace_back(pejeOut);
        ...
        mutTxTest5.vout.emplace_back(pejeOut);
        ...
        mutTxTest6.vout.emplace_back(pejeOut);
        ...
        mutTxTest7.vout.emplace_back(pejeOut);
        ...
        mutTxTest8.vout.emplace_back(pejeOut);

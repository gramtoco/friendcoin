...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler frens tx
        CScript frensTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut frensOut(1*COIN, frensTransfer);
        ...
        mutTxTest1.vout.emplace_back(frensOut);
        ...
        mutTxTest2.vout.emplace_back(frensOut);
        ...
        mutTxTest3.vout.emplace_back(frensOut);
        ...
        mutTxTest4.vout.emplace_back(frensOut);
        ...
        mutTxTest5.vout.emplace_back(frensOut);
        ...
        mutTxTest6.vout.emplace_back(frensOut);
        ...
        mutTxTest7.vout.emplace_back(frensOut);
        ...
        mutTxTest8.vout.emplace_back(frensOut);

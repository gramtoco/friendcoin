...
BOOST_FIXTURE_TEST_SUITE(addrman_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(addrman_simple_test)
    {
        ...
        CService addr1 = ResolveService("250.1.1.1", 2024);
        BOOST_CHECK(addrman.Add(CAddress(addr1, NODE_NONE), source));
        BOOST_CHECK_EQUAL(addrman.size(), (uint64_t)1);
        CAddrInfo addr_ret1 = addrman.Select();
        BOOST_CHECK_EQUAL(addr_ret1.ToString(), "250.1.1.1:2024");

        // Test: Does IP address deduplication work correctly.
        //  Expected dup IP should not be added.
        CService addr1_dup = ResolveService("250.1.1.1", 2024);
        ...
        CService addr2 = ResolveService("250.1.1.2", 2024);
        ...
        vAddr.push_back(CAddress(ResolveService("250.1.1.3", 2024), NODE_NONE));
        vAddr.push_back(CAddress(ResolveService("250.1.1.4", 2024), NODE_NONE));
    ...
    BOOST_AUTO_TEST_CASE(addrman_ports_test)
    {
        ...
        BOOST_CHECK_EQUAL(addr_ret2.ToString(), "250.1.1.1:2024");
        ...
        BOOST_CHECK_EQUAL(addr_ret3.ToString(), "250.1.1.1:2024");
    }
    ...
    BOOST_AUTO_TEST_CASE(addrman_select_test)
    {
        ...
        CService addr2 = ResolveService("250.3.1.1", 2024);
        CService addr3 = ResolveService("250.3.2.2", 9999);
        CService addr4 = ResolveService("250.3.3.3", 9999);

        addrman.Add(CAddress(addr2, NODE_NONE), ResolveService("250.3.1.1", 2024));
        addrman.Add(CAddress(addr3, NODE_NONE), ResolveService("250.3.1.1", 2024));
        addrman.Add(CAddress(addr4, NODE_NONE), ResolveService("250.4.1.1", 2024));

        // Add three addresses to tried table.
        CService addr5 = ResolveService("250.4.4.4", 2024);
        CService addr6 = ResolveService("250.4.5.5", 7777);
        CService addr7 = ResolveService("250.4.6.6", 2024);

        addrman.Add(CAddress(addr5, NODE_NONE), ResolveService("250.3.1.1", 2024));
        addrman.Good(CAddress(addr5, NODE_NONE));
        addrman.Add(CAddress(addr6, NODE_NONE), ResolveService("250.3.1.1", 2024));
        addrman.Good(CAddress(addr6, NODE_NONE));
        addrman.Add(CAddress(addr7, NODE_NONE), ResolveService("250.1.1.3", 2024));
    ...
    BOOST_AUTO_TEST_CASE(addrman_find_test)
    {
        ...
        CAddress addr1 = CAddress(ResolveService("250.1.2.1", 2024), NODE_NONE);
        CAddress addr2 = CAddress(ResolveService("250.1.2.1", 9999), NODE_NONE);
        CAddress addr3 = CAddress(ResolveService("251.255.2.1", 2024), NODE_NONE);
        ...
        BOOST_REQUIRE(info1);
        BOOST_CHECK_EQUAL(info1->ToString(), "250.1.2.1:2024");
        ...
        BOOST_REQUIRE(info3);
        BOOST_CHECK_EQUAL(info3->ToString(), "251.255.2.1:2024");
    }
    ...
    BOOST_AUTO_TEST_CASE(addrman_create_test)
    {
        ...
        BOOST_CHECK_EQUAL(pinfo->ToString(), "250.1.2.1:2024");

        CAddrInfo *info2 = addrman.Find(addr1);
        BOOST_CHECK_EQUAL(info2->ToString(), "250.1.2.1:2024");
    }
    ...
    BOOST_AUTO_TEST_CASE(addrman_getaddr_test)
    {
        ...
        CAddress addr1 = CAddress(ResolveService("250.250.2.1", 2024), NODE_NONE);
        addr1.nTime = GetAdjustedTime(); // Set time so isTerrible = false
        CAddress addr2 = CAddress(ResolveService("250.251.2.2", 9999), NODE_NONE);
        addr2.nTime = GetAdjustedTime();
        CAddress addr3 = CAddress(ResolveService("251.252.2.3", 2024), NODE_NONE);
        addr3.nTime = GetAdjustedTime();
        CAddress addr4 = CAddress(ResolveService("252.253.3.4", 2024), NODE_NONE);
        addr4.nTime = GetAdjustedTime();
        CAddress addr5 = CAddress(ResolveService("252.254.4.5", 2024), NODE_NONE);
    ...
    BOOST_AUTO_TEST_CASE(caddrinfo_get_tried_bucket_test)
    {
        ...
        CAddress addr1 = CAddress(ResolveService("250.1.1.1", 2024), NODE_NONE);

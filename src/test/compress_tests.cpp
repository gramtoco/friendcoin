...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1PEJE 10000

// amounts 50 .. 21000000
#define NUM_MULTIPLES_50PEJE 420000
...
BOOST_FIXTURE_TEST_SUITE(compress_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(compress_amounts_test)
    {
        ...
        BOOST_CHECK(TestPair(500 * COIN, 0x1388));
        ...
        for (uint64_t i = 1; i <= NUM_MULTIPLES_1PEJE; i++)
            BOOST_CHECK(TestEncode(i * COIN));

        for (uint64_t i = 1; i <= NUM_MULTIPLES_50PEJE; i++)

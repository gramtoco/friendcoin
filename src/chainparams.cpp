...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000000007c25e730d306a6"); // Block 145745

        // By default assume that the signatures in ancestors of this block are valid. 
        consensus.defaultAssumeValid = uint256S("0x000000000210c2769f7c0c4ff9f068ccfe619ce60751f91c41e8bc1763c1ebe1"); // Block 145745
        ...
        chainTxData = ChainTxData{
            ...
            // Stats as of 
            1687902242, // * UNIX timestamp of last known number of transactions
            203503,    // * total number of transactions between genesis and that timestamp
                        //   getchaintxstats(the tx=... number in the SetBestChain debug.log lines)
            0.054       // * estimated number of transactions per second after that timestamp
        };

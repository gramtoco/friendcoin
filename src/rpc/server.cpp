...
CAmount AmountFromValue(const UniValue& value, bool p_isPEJE)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "Pejecoin server stopping";
}
...
{
    return "> pejecoin-cli " + methodname + " " + args + "\n";
}

...
#ifndef PEJECOIN_RPCSERVER_H
#define PEJECOIN_RPCSERVER_H
...
/**
 * Pejecoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_isPEJE = true);

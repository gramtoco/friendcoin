...
#ifndef PEJECOIN_QT_PEJECOINGUI_H
#define PEJECOIN_QT_PEJECOINGUI_H
...
/**
  Pejecoin GUI main class. This class represents the main window of the Pejecoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PejecoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PejecoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~PejecoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a pejecoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private:
    ...
    QComboBox *comboPejeUnit = nullptr;
...
#endif // PEJECOIN_QT_PEJECOINGUI_H

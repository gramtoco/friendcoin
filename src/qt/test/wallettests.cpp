...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<FrenAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_fren-qt -platform xcb      # Linux
//     src/qt/test/test_fren-qt -platform windows  # Windows
//     src/qt/test/test_fren-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = FrenUnits::formatWithUnit(unit, balance, false, FrenUnits::separatorAlways);
    ...
    // Amount input
    FrenAmountField* amountInput = receiveCoinsDialog.findChild<FrenAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: fren:")) != -1);

...
#include "qt/pejecoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<PejecoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_pejecoin-qt -platform xcb      # Linux
//     src/qt/test/test_pejecoin-qt -platform windows  # Windows
//     src/qt/test/test_pejecoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = PejecoinUnits::formatWithUnit(unit, balance, false, PejecoinUnits::separatorAlways);
    ...
    // Amount input
    PejecoinAmountField* amountInput = receiveCoinsDialog.findChild<PejecoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: pejecoin:")) != -1);

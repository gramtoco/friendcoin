...
#include "config/fren-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatFrenURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + FrenUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatFrenURI(info));
}

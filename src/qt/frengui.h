...
#ifndef FREN_QT_FRENGUI_H
#define FREN_QT_FRENGUI_H
...
/**
  Fren GUI main class. This class represents the main window of the Fren UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class FrenGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit FrenGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~FrenGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a fren wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */

...
#ifndef PEJECOIN_QT_PEJECOINUNITS_H
#define PEJECOIN_QT_PEJECOINUNITS_H
...
/** Pejecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PejecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PejecoinUnits(QObject *parent);
...
typedef PejecoinUnits::Unit PejecoinUnit;

#endif // PEJECOIN_QT_PEJECOINUNITS_H

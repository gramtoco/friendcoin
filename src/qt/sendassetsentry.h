...
#ifndef PEJECOIN_QT_SENDASSETSENTRY_H
#define PEJECOIN_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending pejes.
...
#endif // PEJECOIN_QT_SENDASSETSENTRY_H

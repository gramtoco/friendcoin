...
#ifndef FREN_QT_FRENUNITS_H
#define FREN_QT_FRENUNITS_H
...
/** Fren unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FrenUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FrenUnits(QObject *parent);
...
typedef FrenUnits::Unit FrenUnit;

#endif // FREN_QT_FRENUNITS_H

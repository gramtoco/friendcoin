...
find ${DISTNAME}/bin -type f -executable -exec ../frencoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../frencoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/frencoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/frencoin/depends/SDKs/MacOSX10.11.sdk.tar.gz

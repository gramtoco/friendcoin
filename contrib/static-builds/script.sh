...
find ${DISTNAME}/bin -type f -executable -exec ../pejecoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../pejecoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/pejecoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/pejecoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
